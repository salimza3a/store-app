...
import { Button, Card, CardActions, CardContent, IconButton, ImageListItem, ImageListItemBar, Typography } from "@mui/material"
...
const ProductDetail = () => {
    ...
    const { data: productDetail, isSuccess, isLoading, isError } = useGetProductByIdQuery(id)
